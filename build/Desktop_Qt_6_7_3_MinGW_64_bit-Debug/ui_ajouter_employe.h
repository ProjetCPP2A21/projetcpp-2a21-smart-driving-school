/********************************************************************************
** Form generated from reading UI file 'ajouter_employe.ui'
**
...
#ifndef UI_AJOUTER_EMPLOYE_H
#define UI_AJOUTER_EMPLOYE_H
...
public:
    ...
    QLabel *label_10;
    QPushButton *BretourAjouterEmploye;
    QPushButton *pushButton_ajouter;
    QPushButton *pushButton_annuler;
    QDateEdit *dateEdit_naissance;

    void setupUi(QWidget *ajouter_employe)
    {
        if (ajouter_employe->objectName().isEmpty())
            ajouter_employe->setObjectName("ajouter_employe");
        ajouter_employe->resize(1418, 656);
        ajouter_employe->setStyleSheet(QString::fromUtf8("QWidget {\n"
...
"    font-size: 13px;\n"
"}"));
        label = new QLabel(ajouter_employe);
        ...
        ajout = new QGroupBox(ajouter_employe);
        ajout->setObjectName("ajout");
        ajout->setGeometry(QRect(60, 60, 611, 571));
        ajout->setStyleSheet(QString::fromUtf8("QGroupBox {\n"
"    font-weight: bold;\n"
"    font-size: 16px;\n"
"    color: #2c3e50;\n"
...
""));
        ...
        lineEdit_id = new QLineEdit(ajout);
...
""));
        ...
        lineEdit_telephone = new QLineEdit(ajout);
...
""));
        ...
        lineEdit_poste = new QLineEdit(ajout);
...
""));
        ...
        lineEdit_motdepasse = new QLineEdit(ajout);
...
"    padding: 0px;\n"
"}"));
        BretourAjouterEmploye = new QPushButton(ajout);
        BretourAjouterEmploye->setObjectName("BretourAjouterEmploye");
        BretourAjouterEmploye->setGeometry(QRect(490, 60, 91, 41));
        BretourAjouterEmploye->setStyleSheet(QString::fromUtf8("QPushButton {\n"
...
"}"));
        ...
        pushButton_ajouter->setGeometry(QRect(330, 480, 91, 41));
...
"}\n"
""));
        pushButton_annuler = new QPushButton(ajout);
...
"}\n"
""));
        dateEdit_naissance = new QDateEdit(ajout);
...
"}"));
        ...
        retranslateUi(ajouter_employe);

        QMetaObject::connectSlotsByName(ajouter_employe);
    } // setupUi

    void retranslateUi(QWidget *ajouter_employe)
    {
        ajouter_employe->setWindowTitle(QCoreApplication::translate("ajouter_employe", "Ajouter un employ\303\251", nullptr));
        label->setText(QString());
        ajout->setTitle(QString());
        label_2->setText(QCoreApplication::translate("ajouter_employe", "ID Employ\303\251", nullptr));
        lineEdit_id->setPlaceholderText(QCoreApplication::translate("ajouter_employe", "Entrez l'ID employ\303\251", nullptr));
        label_3->setText(QCoreApplication::translate("ajouter_employe", "Nom", nullptr));
        lineEdit_nom->setPlaceholderText(QCoreApplication::translate("ajouter_employe", "Entrez le nom", nullptr));
        label_4->setText(QCoreApplication::translate("ajouter_employe", "Pr\303\251nom", nullptr));
        lineEdit_prenom->setPlaceholderText(QCoreApplication::translate("ajouter_employe", "Entrez le pr\303\251nom", nullptr));
        label_5->setText(QCoreApplication::translate("ajouter_employe", "Date de naissance", nullptr));
        label_6->setText(QCoreApplication::translate("ajouter_employe", "Email", nullptr));
        lineEdit_email->setPlaceholderText(QCoreApplication::translate("ajouter_employe", "exemple@email.com", nullptr));
        label_7->setText(QCoreApplication::translate("ajouter_employe", "T\303\251l\303\251phone", nullptr));
        lineEdit_telephone->setPlaceholderText(QCoreApplication::translate("ajouter_employe", "58 588 255", nullptr));
        label_8->setText(QCoreApplication::translate("ajouter_employe", "Poste", nullptr));
        lineEdit_poste->setPlaceholderText(QCoreApplication::translate("ajouter_employe", "Responsable", nullptr));
        label_9->setText(QCoreApplication::translate("ajouter_employe", "Mot de passe", nullptr));
        lineEdit_motdepasse->setPlaceholderText(QCoreApplication::translate("ajouter_employe", "Mot de passe", nullptr));
        label_10->setText(QCoreApplication::translate("ajouter_employe", "Ajouter un Employ\303\251", nullptr));
        BretourAjouterEmploye->setText(QCoreApplication::translate("ajouter_employe", "Retour", nullptr));
        pushButton_ajouter->setText(QCoreApplication::translate("ajouter_employe", "Ajouter", nullptr));
        pushButton_annuler->setText(QCoreApplication::translate("ajouter_employe", "Annuler", nullptr));
    } // retranslateUi

};

namespace Ui {
    class ajouter_employe: public Ui_ajouter_employe {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_AJOUTER_EMPLOYE_H
